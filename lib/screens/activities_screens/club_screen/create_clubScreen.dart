...
class ClubScreenWalkthrow extends StatefulWidget with ChangeNotifier {
  int colorHexa = 0xffF57B51;
  File _image;
  String url;
  String basee64Image;
  String imgType;

  _ClubScreenWalkthrowState createState() => _ClubScreenWalkthrowState();
}

class _ClubScreenWalkthrowState extends State<ClubScreenWalkthrow> {
  final _formKey = GlobalKey<FormState>();

  final int _numPages = 3;
  final PageController _pageController = PageController(initialPage: 0);
  int _currentPage = 0;
  int value = 0; //  forcategory

  String userCategory = "";
  String clubName = "";
  String clubDescriparion = "";
  String phoneNumber = "";
  String facebookPath = "";
    ...
    return Scaffold(
                                              ...
                                              children: <Widget>[
                                                ...
                                                TextFormField(
                                                  validator: (value) {
                                                    if (value.isEmpty ||
                                                        value.length < 30) {
                                                      return 'Can not be empty or descripyion is too short ';
                                                    }
                                                    return null;
                                                  },
                                                  decoration: InputDecoration(
      ...
      bottomSheet: _currentPage == _numPages - 1
          ? Container(
              ...
              child: GestureDetector(
                onTap: () {
                  Provider.of<ClubData>(context, listen: false).addNewClub(
                    Club(
                      clubName: clubName,
                      clubDescription: clubDescriparion,
                      clubPhone: phoneNumber,
                      facebookPath: facebookPath,
                      imge64: widget.basee64Image,
